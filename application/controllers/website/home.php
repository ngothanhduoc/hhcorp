...
//        $data['gioi_thieu'] = $this->m_home->get_by_id(1);
        ...
        $this->template->write_view('content', 'website/index', $data);
    ...
    public function product($param) { 
        $id = get_id_url($param);
        $data = $this->data;
        $data['list_group_product'] = $this->m_home->get_where('group_product', array('id_group_product !='=> $id));
        $data['chose_group_product'] = $this->m_home->get_where('group_product', array('id_group_product'=> $id));
        $data['id_group_product'] = $id;
