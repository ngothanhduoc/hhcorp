...
$route['product/(:any)']= "website/home/product/$1";
...
$route['get_num_product.html']= "website/ajax/get_num_product";
$route['get-list-product.html']= "website/ajax/get_list_product";
$route['result_address.html']= "website/ajax/result_address";
